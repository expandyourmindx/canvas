...
export const paper = "#1a1b1d";   // the page — main background (neutral/cool dark)
export const paperDark = "#111213";   // sunken panels, input fields
export const paperDeep = "#080809";   // toolbar chrome, button fill
export const paperPanel = "#000000";   // deepest surface / desktop floor
...
export const ink = "#e3e5e8";   // primary — borders, text, filled notes
export const inkMid = "#a1a4a8";   // secondary — labels, less-critical UI
export const inkLight = "#676a6e";   // tertiary — grid lines, dividers
export const inkGhost = "#36383b";   // barely there — background grid, empty VU
...
// ── NOTE / CLIP BLOCKS ───────────────────────────────────────
export const note = "#d1d4d8";   // filled note/clip rectangle — light on dark page
...
export const keyWhite = "#d1d4d8";   // white key — same as note (light)
export const keyBlack = "#181410";   // black key — same as paperPanel (dark)

// ── GRID HIERARCHY ───────────────────────────────────────────
export const gridBar = "#5a5d61";   // bar lines — most prominent
export const gridBeat = "#3f4145";   // beat lines — visible
...
export const gemRaised = () => ({
  borderTop: `1px solid ${inkMid}`,
  borderLeft: `1px solid ${inkMid}`,
  borderBottom: `1px solid ${paperPanel}`,
  borderRight: `1px solid ${paperPanel}`,
});

export const gemSunken = () => ({
  borderTop: `1px solid ${paperPanel}`,
  borderLeft: `1px solid ${paperPanel}`,
  borderBottom: `1px solid ${inkMid}`,
  borderRight: `1px solid ${inkMid}`,
});

export const inkBorder = () => ({
  border: `1px solid ${inkMid}`,
});
